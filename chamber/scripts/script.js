...
const OWM_API_KEY = 'f80e43cbf37295dc0426f9319f6d3206';
...
const SPOTLIGHT_IMAGES = {
  'banco-popular.svg':         'https://images.unsplash.com/photo-1541354329998-f4d9a9f9297f?w=300&q=70&fm=webp',
  'supermercado-nacional.svg': 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=300&q=70&fm=webp',
  'hotel-lina.svg':            'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=300&q=70&fm=webp',
  'farmacia-carol.svg':        'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=300&q=70&fm=webp',
  'constructora-herrera.svg':  'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=300&q=70&fm=webp',
  'instituto-tecnologico.svg': 'https://images.unsplash.com/photo-1580582932707-520aed937b7b?w=300&q=70&fm=webp',
  'panaderia-espanola.svg':    'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=300&q=70&fm=webp',
  'auto-repuestos-diaz.svg':   'https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=300&q=70&fm=webp',
  'clinica-del-oeste.svg':     'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=300&q=70&fm=webp',
};
...
async function loadForecast() {
  ...
  try {
    ...
    for (let i = 0; i < data.list.length; i++) {
      ...
      if (date.toDateString() !== today && item.dt_txt.includes("12:00:00")) {
        days.push({
